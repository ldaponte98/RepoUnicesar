                            ...
                            <div class="card-block">
                                ...
                                <div class="form-horizontal form-material">
                                     ...
                                     <div class="form-group">
                                        ...
                                        <div class="col-sm-12">
                                            <select id="cor" class="form-control form-control-line" readonly>
                                                <option value="<?php echo e($seguimiento->corte); ?>"><?php echo e($seguimiento->corte); ?></option>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-12">
                                            <select id="asi" class="form-control form-control-line" readonly  >
                                                <option value="<?php echo e($seguimiento->id_asignatura); ?>"><?php echo e($seguimiento->asignatura->nombre); ?></option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                           <select id="gru" class="form-control form-control-line"  >
                                                <option value="<?php echo e($seguimiento->id_grupo); ?>"><?php echo e($seguimiento->grupo->codigo); ?></option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-12">
                                             <input id="cre" type="text" class="form-control form-control-line " value="<?php echo e($seguimiento->asignatura->num_creditos); ?>" readonly>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <input id="num_estudiantes_iniciales" value="<?php echo e($seguimiento->grupo->num_est_ini); ?>" type="number" class="form-control form-control-line" readonly>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-12" style="color: black;">Numero de estudiantes asistentes <b>*</b></label>
                                        <div class="col-md-12">
                                            <input id="num_estudiantes" name="num_estudiantes" value="<?php echo e($seguimiento->grupo->num_est_ini); ?>" type="number" class="form-control form-control-line" required="" max="<?php echo e($seguimiento->grupo->num_est_ini); ?>" min="0" onchange="validar_cantidad_de_estudiantes()">
                                        </div>
                                    ...
                                    <div class="col-md-6  ">
                                    <a  id="btnsubir" target="_blank" href='<?php echo e(route('seguimiento/view', $seguimiento->id_seguimiento)); ?>' class="btn   btn-success" style="color: white;">Ver mi ultimo registro</a>
                                ...
                                <div class="form-horizontal form-material">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                            <input id="prom_notas" name="prom_notas" max="5" min="0" step="0.1" type="number" class="form-control form-control-line" onchange="validar_promedio_notas()" style="margin-left: 18px;" value="<?php echo e($seguimiento->prom_notas); ?>">
                                        </div>
                                        <div class="col-md-5">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <input id="aprobados" name="aprobados"  type="number" class="form-control form-control-line " value="<?php echo e($seguimiento->aprobados); ?>" onchange="establecer_reprobados()">
                                        </div>
                                    </div>
                                </div>
                                 <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <input id="reprobados" value="<?php echo e($seguimiento->reprobados); ?>" name="reprobados" type="number" class="form-control form-control-line " readonly  >
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <input id="num_est_sup_promedio" name="num_est_sup_promedio"  type="number" class="form-control form-control-line " value="<?php echo e($seguimiento->num_est_sup_promedio); ?>" onchange="establecer_no_sup_promedio()">
                                        </div>
                                    </div>
                                </div>
                                 <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <input id="num_est_no_sup_promedio" value="<?php echo e($seguimiento->num_est_no_sup_promedio); ?>" name="num_est_no_sup_promedio" type="number" class="form-control form-control-line " readonly  >
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <input id="estrategias_didacticas" name="estrategias_didacticas" type="text" class="form-control form-control-line " value="<?php echo e($seguimiento->estrategias_didacticas); ?>">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-12" style="color: black;">Estrategias evaluativas exitosas que desee compartir con sus colegas <b>*</b></label>
                                        <div class="col-md-12">
                                            <input id="estrategias_evaluativas" name="estrategias_evaluativas" type="text" class="form-control form-control-line " value="<?php echo e($seguimiento->estrategias_evaluativas); ?>">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <input id="estrategias_desa_cont_programatico" type="text" name="estrategias_desa_cont_programatico" placeholder="Solo si R<100%" class="form-control form-control-line " value="<?php echo e($seguimiento->estrategias_desa_cont_programatico); ?>">
                                        </div>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <input id="si_porc_efi_critico" name="si_porc_efi_critico" type="text" class="form-control form-control-line " value="<?php echo e($seguimiento->si_porc_efi_critico); ?>">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-12" style="color: black;">Sugerencias u observaciones generales </label>
                                        <div class="col-md-12">
                                            <input id="sugerencias" name="sugerencias" type="text" class="form-control form-control-line " value="<?php echo e($seguimiento->sugerencias); ?>">
                                        </div>
                                    </div>
                                    <br>
                                    <div class="col-md-6  ">
       ...
       <script type="text/javascript">
        ...
        function validar_promedio_notas(){
       	...
       	function guardar(){
            ...
            var url = '<?php echo e(route('seguimiento/editar', $seguimiento->id_seguimiento)); ?>'
            ...
            var data = {
                '_token' : token,
                'id_seguimiento' : <?php echo e($seguimiento->id_seguimiento); ?>,
            ...
            $.post(url, data, function(response){
                ...
                if(response.error == false){
                    ...
                    window.open('<?php echo e(route('seguimiento/view', $seguimiento->id_seguimiento)); ?>', '_blank');
                }else{ 
        ...
        function cargar_unidades_ejes_causa_analisis_antiguos() {
            ...
            var url = '<?php echo e(route('seguimiento/getSeguimiento', $seguimiento->id_seguimiento)); ?>'
...
<?php echo $__env->make('layouts.main_docente', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\RepoUnicesar\resources\views/seguimiento_asignatura/editar_desde_docente.blade.php ENDPATH**/ ?>