                ...
                <div class="form-group">
                    <?php echo e(Form::open()); ?>
                                  ...
                                  <div class="row">
                                      ...
                                      <?php if($plan_trabajo->id_plan_trabajo != null): ?>
                                      <div class="col-sm-2">
                                        <a target="_blank" href="<?php echo e(route('plan_trabajo/imprimir', $plan_trabajo->id_plan_trabajo)); ?>" style="color: white; width: 100%; height: 100%; font-size: 16px;"  class="btn btn-info">Imprimir</a>
                                      </div>
                                      <div class="col-sm-1"></div>
                                      <div class="col-sm-3">
                                        <?php if($plan_trabajo->estado == "Enviado"): ?>
                                        ...
                                        <?php endif; ?>
                                        <?php if($plan_trabajo->estado == "Recibido"): ?>
  ...
  label{
    color: black !important;
            ...
            <div class="row" >
              <div class="col-sm-12">
                <div class="form-group">
              <?php if(!$plan_trabajo->id_plan_trabajo): ?>
              ...
              <?php endif; ?>
                  ...
                  <div id="div_form_plan_trabajo" style="display: none">
                    ...
                    <input type="hidden" id="id_plan_trabajo" value="<?php echo e($plan_trabajo->id_plan_trabajo); ?>">
                  <input type="hidden" id="id_periodo_academico" value="<?php echo e($periodo_academico->id_periodo_academico); ?>">
                  <input type="hidden" id="id_tercero" value="<?php echo e($tercero->id_tercero); ?>">
                    ...
                    <table class="tabla_info" width="100%" cellspacing="0" cellpadding="0" border="1">
                      <tr>
                        ...
                        <td colspan="1" class="td_valor"><input class="input_info" id="total_asignaturas" name="total_asignaturas" value="<?php echo e(count($tercero->asignaturas_por_periodo_academico($periodo_academico->id_periodo_academico))); ?>" readonly>
                      ...
                      <tr>
                        ...
                        <td colspan="1" class="td_valor">
                         <input id="total_grupos" name="total_grupos" class="input_info" value="<?php echo e(count($tercero->grupos_por_periodo_academico($periodo_academico->id_periodo_academico))); ?>" readonly></td>
                      </tr>
                      <tr>
                        <td colspan="3"><label style="color: black;"><b>Total estudiantes</b></label></td>
                        <td colspan="1" class="td_valor">
                         <input id="total_estudiantes" name="total_estudiantes" class="input_info" value="<?php echo e($tercero->num_estudiantes_por_periodo_academico($periodo_academico->id_periodo_academico)); ?>" readonly></td>
                      ...
                      <tr>
                        ...
                        <td colspan="1" class="td_valor">
                          <input id="horas_docencia_directa" name="horas_docencia_directa"  class="input_info" value="<?php echo e($tercero->total_horas_docencia($periodo_academico->id_periodo_academico)); ?>" readonly></td>

                      </tr>
                      <tr>
                        <td colspan="3"><label style="color: black;"><b>Total horas de atencion a estudiantes</b></label></td>
                        <td colspan="1" class="td_valor">
                         <input id="horas_atencion_estudiantes" name="horas_atencion_estudiantes" class="input_info" value="<?php echo e($tercero->total_horas_atencion_a_estudiantes($periodo_academico->id_periodo_academico)); ?>"></td>
                      </tr>
                      <tr>
                        <td colspan="3"><label style="color: black;"><b>Total horas de preparacion y evaluacion de las asignaturas</b></label></td>
                        <td colspan="1" class="td_valor">
                         <input id="horas_preparacion_evaluacion" name="horas_preparacion_evaluacion"  class="input_info" value="<?php echo e($tercero->total_horas_preparacion_evaluacion($periodo_academico->id_periodo_academico)); ?>"></td>
                      </tr>
                      ...
                      <tr>
                        ...
                        <td colspan="1" class="td_valor"><b>
                          ...
                          ?>
                         <input id="horas_dedicadas_actividades" name="horas_dedicadas_actividades" style="font-weight:bold;"  class="input_info" value="<?php echo e($total_horas_actividades_docente); ?>"></b></td>
                      </tr>

                      <tr>
                        <td colspan="3"><label style="color: black;"><b>Total horas de orientación y evaluación de los trabajos de grado</b></label></td>
                        <td colspan="1" class="td_valor">
                         <input id="horas_orientacion_proyectos" name="horas_orientacion_proyectos"  class="input_info" value="<?php echo e($plan_trabajo->horas_orientacion_proyectos); ?>" readonly></td>
                      </tr>

                       <tr>
                        <td colspan="3"><label style="color: black;"><b>Total horas dedicadas a la investigación aprobada</b></label></td>
                        <td colspan="1" class="td_valor">
                           <input id="horas_investigacion" name="horas_investigacion"  class="input_info" value="<?php echo e($plan_trabajo->horas_investigacion); ?>" readonly></td>
                      </tr>

                       <tr>
                        <td colspan="3"><label style="color: black;"><b>Total horas dedicadas a la proyeccion social registrada</b></label></td>
                        <td colspan="1" class="td_valor">
                           <input id="horas_proyeccion_social" name="horas_proyeccion_social"  class="input_info" value="<?php echo e($plan_trabajo->horas_proyeccion_social); ?>" readonly></td>
                      </tr> 
                      <tr>
                        <td colspan="3"><label style="color: black;"><b>Total horas dedicadas a la cooperación interinstitucional</b></label></td>
                        <td colspan="1" class="td_valor">
                           <input id="horas_cooperacion" name="horas_cooperacion"  class="input_info" value="<?php echo e($plan_trabajo->horas_cooperacion); ?>" readonly></td>
                      </tr>  
                      <tr>
                        <td colspan="3"><label style="color: black;"><b>Total horas dedicadas para el crecimiento personal y profesional</b></label></td>
                        <td colspan="1" class="td_valor">
                           <input id="horas_crecimiento_personal" name="horas_crecimiento_personal"  class="input_info" value="<?php echo e($plan_trabajo->horas_crecimiento_personal); ?>" readonly></td>
                      </tr> 
                      <tr>
                        <td colspan="3"><label style="color: black;"><b>Total horas dedicadas a las actividades administrativas</b></label></td>
                        <td colspan="1" class="td_valor">
                           <input id="horas_actividades_administrativas" name="horas_actividades_administrativas"  class="input_info" value="<?php echo e($plan_trabajo->horas_actividades_administrativas); ?>" readonly>
                         </td>
                      </tr> 
                       <tr>
                        <td colspan="3"><label style="color: black;"><b>Total horas para otras actividades</b></label></td>
                        <td colspan="1" class="td_valor">
                           <input id="horas_otras_actividades" name="horas_otras_actividades"  class="input_info" value="<?php echo e($plan_trabajo->horas_otras_actividades); ?>" readonly>
                         </td>
                      </tr>
                      <tr>
                        <td colspan="3"><label style="color: black;"><b>Total horas dedicadas a las actividades docente complementarias</b></label></td>
                        <td colspan="1" class="td_valor">
                           <input id="horas_actividades_complementarias" name="horas_actividades_complementarias" style="font-weight: bold;"  class="input_info" value="<?php echo e($plan_trabajo->horas_actividades_complementarias); ?>">
                         </td>
                      </tr> 
                      <tr style="background-color: #c7e6a4">
                        <td colspan="3"><label style="color: black;"><b>Total de horas por plan de trabajo</b></label></td>
                        <td colspan="1" class="td_valor">
                           <input id="total_horas_semana" name="total_horas_semana" style="font-weight: bold; background-color: transparent;" class="input_info" value="<?php echo e($total_horas_actividades_docente + $plan_trabajo->horas_actividades_complementarias); ?>" readonly>
                         </td>
                      </tr>       
                    </table> 
                    ...
                    <div class="row">
                      <div class="col-sm-12">
                           ...
                           <input id="observaciones" name="observaciones" type="text"  class="form-control form-control-line" placeholder="Escriba aqui cualquier observacion con relacion a este plan de trabajo" value="<?php echo e($plan_trabajo->observaciones); ?>">
                      </div>
                    </div>
                    <br><br>
                      ...
                      <div class="card-header bg-info">
                        <div class="row">
                          ...
                          <div class="pull-right">
                            <?php if($permiso_para_modificar == true): ?>
                      ...
                      <div class="table-responsive" id="tabla_proyectos_grado" >
                          <table class="table table-bordered">
                              ...
                              <tbody id="bodytable_proyectos_grados">
                                  ...
                                  <?php if($actividad->id_dominio_tipo == 18): ?><!--p. grado-->
                                  <tr>
                                    <td><?php echo e($actividad->nombre); ?></td>
                                    <td><?php echo e($actividad->acta_aprobada); ?></td>
                                    <td><?php
                                    ...
                                    <td><center><a onclick="eliminarActividad('<?php echo e($actividad->nombre); ?>' , <?php echo e($actividad->id_dominio_tipo); ?>)" style="font-size: 25px; color: red; cursor: pointer;"><i class="fa fa-times"></i></a></center>
                                    </td>
                                    </tr>
                                  <script>
                                    agregar_antiguas_actividades(<?php echo e($actividad->id_dominio_tipo); ?>,'<?php echo e($actividad->nombre); ?>','<?php echo e($actividad->descripcion); ?>','<?php echo e($actividad->institucion); ?>','<?php echo e($actividad->acta_aprobada); ?>','<?php echo e($actividad->fecha_aprobada); ?>','<?php echo e($actividad->fecha_iniciacion); ?>','<?php echo e($actividad->fecha_terminacion); ?>',<?php echo e($actividad->horas_por_semana); ?>,'<?php echo e($actividad->requiere_actividad_complementaria); ?>')
                                  </script>
                                  <?php endif; ?>
                                  <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<script>
  ...
  function validarHorasPermitidas(horas_no_validas, horas_solicitadas){
    $respuesta = true
    tipo_docente = '<?php echo e($tercero->servicio); ?>'
    var respuesta = {
        'error' : false,
        'mensaje' : ''
    }
  ...
  function guardar(){
    ...
    var url = '<?php echo e(route('plan_trabajo/editar')); ?>'
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make((session("is_admin") == true ? 'layouts.main' : 'layouts.main_docente'), \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\RepoUnicesar\resources\views/plan_de_trabajo/view.blade.php ENDPATH**/ ?>