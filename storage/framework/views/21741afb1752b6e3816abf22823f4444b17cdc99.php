...
<?php echo e(Form::close()); ?>
                ...
                function consultar(){
                    ...
                    var url = "<?php echo e(route('plan_trabajo/getReporte')); ?>"
        ...
        function NotificarRetraso() {
            ...
            var data = {
                ...
                id_dominio_tipo_formato : <?php echo e(config('global.plan_trabajo')); ?>,
                _token : _token
            };
            $.blockUI({
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\RepoUnicesar\resources\views/plan_de_trabajo/consultar.blade.php ENDPATH**/ ?>