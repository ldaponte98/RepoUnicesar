            ...
            <nav class="navbar top-navbar navbar-toggleable-sm navbar-light">
                ...
                <div class="navbar-collapse">
                    ...
                    <ul class="navbar-nav mr-auto mt-md-0 ">
                        ...
                        <li class="nav-item dropdown">
                            <a id="mobile_agregar_clase" href="<?php echo e(route('clases/gestion')); ?>" class="nav-link dropdown-toggle text-muted text-muted waves-effect waves-dark"> <i class="mdi mdi-plus-box"></i>
                            </a>
                        </li>
            ...
            <div class="scroll-sidebar">
                ...
                <ul id="sidebarnav" class="in">
                    ...
                    <li class="nav-small-cap">Clases</li>
                     <li>
                        <a href="<?php echo e(route('clases/mis_clases_pendientes')); ?>" class="waves-effect" style="display: flex !important;">
