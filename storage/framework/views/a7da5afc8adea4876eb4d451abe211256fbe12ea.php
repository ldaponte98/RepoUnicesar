                ...
                <div class="col-sm-4">
                                ...
                                <br>
                                 ...
                                 <center>
                                  <?php if($is_admin == true): ?>
                                    <span>
                                  <a href="<?php echo e(route('fechas/editar_fechas_de_entrega',['periodo' => $periodo_academico->id_periodo_academico, 'formato' =>  config('global.plan_trabajo') ])); ?>" title="Editar fechas"><i class="fa fa-pencil rounded-circle" aria-hidden="true"></i></a></span>
                                  <?php endif; ?>
                    ...
                    <div class="col-sm-4">
                        <div class="card-section card-section-1 border rounded">
                            ...
                            <div class="card-body text-center mb-2" style="padding: 15px">
                                ...
                                <span><a href="<?php echo e(route('fechas/editar_fechas_de_entrega',['periodo' => $periodo_academico->id_periodo_academico, 'formato' =>  config('global.desarrollo_asignatura') ])); ?>" title="Editar fechas"><i class="fa fa-pencil rounded-circle" aria-hidden="true"></i></a></span>
                                <?php endif; ?>
                                </center>
                            </div>
                        </div>
                        ...
                        <div class="card-section card-section-1 border rounded">
                            ...
                            <div class="card-body mb-2" style="padding: 15px">
                                ...
                                <?php endif; ?> 
                                 ...
                                 <center>
                                  <?php if($is_admin == true): ?>
                                <span><a href="<?php echo e(route('fechas/editar_fechas_de_entrega',['periodo' => $periodo_academico->id_periodo_academico, 'formato' =>  config('global.seguimiento_asignatura') ])); ?>" title="Editar fechas"><i class="fa fa-pencil rounded-circle" aria-hidden="true"></i></a></span>
                                <?php endif; ?>
                                </center>
                            </div>
                        </div>
                        ...
                        <div class="card-section card-section-1 border rounded">
                            ...
                            <div class="card-body mb-2" style="padding: 15px">
                                ...
                                <?php endif; ?>                                 
                                 ...
                                 <center>
                                  <?php if($is_admin == true): ?>
                                <span><a href="<?php echo e(route('fechas/editar_fechas_de_entrega',['periodo' => $periodo_academico->id_periodo_academico, 'formato' =>  config('global.actividades_complementarias') ])); ?>" title="Editar fechas"><i class="fa fa-pencil rounded-circle" aria-hidden="true"></i></a></span>
                                  <?php endif; ?>
                                </center>
                    ...
                    <div class="col-sm-4">
                        <div class="card-section card-section-1 border rounded">
                            ...
                            <div class="card-body text-center mb-2" style="padding: 15px">
                                <br><br><br><br>
                                <?php if($fechas_de_entrega_plan_accion != null): ?>
                                    <b>Desde <?php echo e(date('d/m/Y', strtotime($fechas_de_entrega_plan_accion->fechainicial1))); ?> hasta <?php echo e(date('d/m/Y', strtotime($fechas_de_entrega_plan_accion->fechafinal1))); ?></b>
                                <?php else: ?>
                                    <center><b>Fechas no asignadas </b></center>
                                <?php endif; ?> 
                                <br>
                                ...
                                <br>
                                 ...
                                 <center>
                                  <?php if($is_admin == true): ?>
                                <span><a href="<?php echo e(route('fechas/editar_fechas_de_entrega',['periodo' => $periodo_academico->id_periodo_academico, 'formato' =>  config('global.plan_accion') ])); ?>" title="Editar fechas"><i class="fa fa-pencil rounded-circle" aria-hidden="true"></i></a></span>
                                  <?php endif; ?>
                                </center>
                            </div>
                        </div>
