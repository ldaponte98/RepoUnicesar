		 ...
		 <div class="row">
                        ...
                        <div class="card">
                            <div class="card-block">
                              <center>
                                ...
                                <h4 class="card-title"><?php echo e($docente->cedula); ?></h4></center>
                 				...
                 				<div class="col-sm-12">
                                        <div class="card" style="margin-bottom: 0px">
                                            <div class="card-block">
                                                ...
                                                <center class="m-t-30">
                                                <img id="imagen_update" src="<?php echo e(asset('files/'.$docente->cedula.'/'.$docente->foto)); ?>" class="img-circle" width="200" height="200" />
                ...
                <div class="row">
                    <div class="col-sm-12">
                            ...
                            <center class="m-t-30">
                            	<?php echo e(Form::open(array('route' => array('docente/update_image', $docente->id_tercero), 'method' => 'post' , 'files' => true))); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make((session("is_admin") == true ? 'layouts.main' : 'layouts.main_docente'), \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\RepoUnicesar\resources\views/docente/update_image.blade.php ENDPATH**/ ?>