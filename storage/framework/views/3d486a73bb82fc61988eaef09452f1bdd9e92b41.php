...
<div class="row">
                            ...
                            <div class="card-block">
                                <form class="form-horizontal form-material">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <input disabled="" id="cod" type="text" value="<?php echo e($asignatura->codigo); ?>"  class="form-control form-control-line " data-validate="">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-12"><b>Nombre </b></label>
                                        <div class="col-md-12">
                                            <input disabled="" id="nom" type="text" value="<?php echo e($asignatura->nombre); ?>"  class="form-control form-control-line " data-validate="">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-12"><b>Numero de creditos</b></label>
                                        <div class="col-md-12">
                                            <input disabled="" id="cre" type="number" min="1" max="5" maxlength="1" minlength="1"  value="<?php echo e($asignatura->num_creditos); ?>"  class="form-control form-control-line ">
                                        </div>
                                    </div>           
                                </form>
                            </div>
                ...
                <div class="tab-content" id="myTabContent">
                    ...
                    <div class="tab-pane fade" id="programas" role="tabpanel" aria-labelledby="programas-tab">
                      <?php echo e(view('asignatura.listado_programas_academicos',compact('asignatura'))); ?>     
                                        
                    </div>
                    <div class="tab-pane fade" id="unidades" role="tabpanel" aria-labelledby="unidades-tab">
                      <?php echo e(view('asignatura.listado_unidades',compact('asignatura'))); ?>     
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\RepoUnicesar\resources\views/asignatura/view.blade.php ENDPATH**/ ?>