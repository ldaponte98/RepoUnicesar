                    	...
                    	<?php $__currentLoopData = $docente->seguimientos_asignatura; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $seguimiento): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
						        <?php if($seguimiento->estado == 'Pendiente'): ?>
						           <tr>
                                    ...
                                    <td>
                                        <?php if($seguimiento->retraso() != "Fechas sin definir" and $seguimiento->retraso() != "En espera"): ?>
                                        <center>
                                            <a style="color: blue; cursor: pointer;" onclick="OpenModalNotificarRetrasoSeguimiento(<?php echo e($seguimiento->id_seguimiento); ?>,'<?php echo e($usuario->tercero->getNameFull()); ?>','<?php echo e($seguimiento->retraso()); ?>','<?php echo e($seguimiento->asignatura->nombre); ?>', '<?php echo e($seguimiento->grupo->codigo); ?>',<?php echo e($seguimiento->corte); ?>, '<?php echo e($seguimiento->grupo->periodo_academico->periodo); ?>')">Notificar retraso</a>
                                        </center>
                                        <?php endif; ?>
                                    </td>
                                    <td>
                                        ...
                                        <center>
                                            <?php if($seguimiento->retraso() != "Tiene plazo-extra"): ?>
                                                <a style="color: blue; cursor: pointer;" onclick="OpenModalExtraPlazoSeguimiento(<?php echo e($seguimiento->id_seguimiento); ?>)">Extra plazo</a>
                                            <?php else: ?>
                                                <?php
                                                    $plazo_extra = \App\PlazoDocente::where('id_tercero', $seguimiento->id_tercero)
                                                                   ...
                                                                   ->first();
                                                ?>
                                                <a style="color: blue; cursor: pointer;" onclick="OpenModalVerExtraPlazoSeguimiento(<?php echo e($plazo_extra->id_plazo_docente); ?>)">Ver extra plazo</a>
                                            <?php endif; ?>
                                        </center>
                                    <?php endif; ?>
                                    </td> 
    ...
    <script>
        ...
        function ActualizarPlazoExtraSeguimiento() {
            ...
            if(r == true){
                ...
                var url = '<?php echo e(route('plazo_docente/actualizar')); ?>'
