        ...
        <aside class="left-sidebar">
            ...
            <div class="scroll-sidebar">
                ...
                <ul id="sidebarnav" class="in">
                        ...
                        <li>
                            <a href="<?php echo e(route('logout')); ?>" class="waves-effect"><i class="fa fa-sign-out m-r-10" aria-hidden="true"></i><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">Salir</font></font></a>
                        </li>
