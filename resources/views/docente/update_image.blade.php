@extends((session("is_admin") ? 'layouts.main' : (session("is_docente")) ? 'layouts.main_docente' : 'layouts.main_alumno'))
<style type="text/css">
            ...
            <div class="card">
                <div class="card-block">
                    <center>
                        ...
                        <h4 class="card-title">{{ $docente->cedula }}</h4>
                    </center>
                    <div class="row">
         				<div class="col-sm-12">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="form-group">
                            <center class="m-t-30">
                            	{{ Form::open(array('route' => array('docente/update_image', $docente->id_tercero), 
