...
@section('menu')
    <div class="fab-container">
        ...
        <ul class="fab-options">
            <li onclick="location.href='{{ route('docente/horario', $docente->id_tercero) }}'">
                <span class="fab-label">Horario</span>
                <div class="fab-icon-holder">
                    <i class="ti-calendar"></i>
                </div>
            </li>
            <li onclick="location.href='/docente/view_formato/{{ config('global.plan_trabajo') }}/{{ $docente->id_tercero }}'">
                <span class="fab-label">Planes de trabajo</span>
                <div class="fab-icon-holder">
                    <i class="ti-file"></i>
                </div>
            </li>
            <li onclick="location.href='/docente/view_formato/{{ config('global.desarrollo_asignatura') }}/{{ $docente->id_tercero }}'">
                <span class="fab-label">Planes de desarrollo asignatura</span>
                <div class="fab-icon-holder">
                    <i class="ti-cup"></i>
                </div>
            </li>
            <li onclick="location.href='/docente/view_formato/{{ config('global.actividades_complementarias') }}/{{ $docente->id_tercero }}'">
                <span class="fab-label">Actividades complementarias</span>
                <div class="fab-icon-holder">
                    <i class="ti-layers-alt"></i>
                </div>
            </li>
            <li onclick="location.href='/docente/view_formato/{{ config('global.seguimiento_asignatura') }}/{{ $docente->id_tercero }}'">
                        ...
                        <div class="card">
                            <div class="card-block">
                                ...
                                <center class="m-t-30">
                                    ...
                                    @endphp
                                 <a> <img id="fotico" target="Ver imagen" src="{{ asset($imagen) }}" class="img-circle" width="180" height="180" /></a> 
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <input disabled="" id="ema"  value="{{ $docente->vinculacion }}" type="email" class="form-control form-control-line " >
                                            </div> 
                                        </div>
                                    </div>
                                </form>
