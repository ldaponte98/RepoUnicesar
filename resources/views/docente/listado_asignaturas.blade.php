                ...
                <table class="table">
                    ...
                    <tbody id="bodytable">
                    	...
                    	@foreach ($docente->asignaturas() as $asignatura)
						           <tr>
		                    		<td><center>{{ $asignatura->id_asignatura }}</center></td>
                                    <td><center>{{ $asignatura->codigo }}</center></td>
                                    <td><center>{{ $asignatura->nombre }}</center></td>
		                            <td><center>{{ $asignatura->num_creditos }}</center></td>
		                            <td><center><a style="cursor: pointer;" onclick="buscar_grupos({{ $asignatura->id_asignatura }},'{{ $asignatura->nombre }}')"><i class="fa fa-users"></i></a></center></td>   
		                            </tr> 
						@endforeach
                    </tbody>
                </table>
...
<script type="text/javascript">
    function buscar_grupos(id_asignatura, nombre_asignatura) {
        ...
        var id_tercero = "{{ $docente->id_tercero }}"
        var url = "{{ route('grupo/buscar') }}"
