                    ...
                    <tbody id="bodytable">
                    	@foreach ($docente->seguimientos_asignatura as $seguimiento)
						        @if ($seguimiento->estado == 'Enviado')
						           <tr>
                                    <td><center><input type="checkbox" name="check_marcar" value="{{ $seguimiento->id_seguimiento }}" /></center></td>
		                            ...
		                            <td><center>
                                     ...
                                     <td><center>
                                       <a target="_blank" href="{{ route('seguimiento/view', $seguimiento->id_seguimiento) }}">Revisar</a>
                                    </center></td>     
		                            </tr> 
						        @endif
						@endforeach
