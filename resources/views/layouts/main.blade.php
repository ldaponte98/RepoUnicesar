       ...
       <header class="topbar">
        ...
        <aside class="left-sidebar">
            ...
            <div class="scroll-sidebar">
                ...
                <ul id="sidebarnav" class="in">
                        <li >
                            <a href="admin.php" class="waves-effect "><i class="fa fa-window-restore m-r-10" aria-hidden="true"></i><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">Tablero</font></font></a>
                        </li>
                        <li>
