                ...
                <ul id="sidebarnav" class="in">
                        ...
                        <li class="">
                            ...
                            <ul aria-expanded="false" class="collapse">
                                <li>
                                    <a href="{{ route('plan_trabajo/consultar') }}" class="waves-effect" style="font-size:14px;">Plan de trabajo</a>
                                </li>
                                <li>
                                    <a href="{{ route('plan_asignatura/buscar_asignatura') }}" class="waves-effect"style="font-size:14px;">Plan de asignatura</a>
                                </li>
                                <li>
                                    <a href="{{ route('plan_desarrollo_asignatura/consultar') }}" class="waves-effect"style="font-size:14px;">Plan desarrollo asignatura</a>
                                </li>
                                <li class="">
