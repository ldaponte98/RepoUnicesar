        ...
        <aside class="left-sidebar">
            ...
            <div class="scroll-sidebar">
                ...
                <ul id="sidebarnav" class="in">
                        ...
                        <li>
                            <!--<a href="{{ route('docente/view', $usuario->tercero->id_tercero) }}" class="waves-effect" style="display: flex !important;"><i data-feather="user" class="m-r-10" aria-hidden="true"></i></i>Mi perfil</a>-->
                        </li>
                        <li>
