                ...
                <div class="col-sm-4">
                  ...
                  <select name="id_periodo_escojido" class="form-control form-control-line" >
                      @foreach ($periodos as $periodo)
                        <option @if ($periodo->id_periodo_academico == $periodo_academico->id_periodo_academico) selected @endif value="{{ $periodo->id_periodo_academico }}">{{ $periodo->periodo }}</option>
                      @endforeach
                  </select>
                </div>
                <div class="col-sm-2">
    ...
    <div class="card-section card-section-1 border rounded">
      ...
      <div class="card-body text-center mb-2" style="padding: 15px">
         ...
         <center>
          @if ($is_admin == true)
            <span>
              <a href="{{ route('fechas/editar_fechas_de_entrega',['periodo' => $periodo_academico->id_periodo_academico, 'formato' =>  config('global.plan_trabajo') ]) }}" title="Editar fechas"><i class="fa fa-pencil rounded-circle" aria-hidden="true"></i></a>
            </span>
          @endif
        </center>
      </div>
    ...
    <div class="card-section card-section-1 border rounded">
      ...
      <div class="card-body text-center mb-2" style="padding: 15px">
        ...
        <center>
          @if ($is_admin == true)
            <span>
              <a href="{{ route('fechas/editar_fechas_de_entrega',['periodo' => $periodo_academico->id_periodo_academico, 'formato' =>  config('global.desarrollo_asignatura') ]) }}" title="Editar fechas"><i class="fa fa-pencil rounded-circle" aria-hidden="true"></i></a>
            </span>
          @endif
        </center>
      </div>
    ...
    <div class="card-section card-section-1 border rounded">
      ...
      <div class="card-body mb-2" style="padding: 15px">
        ...
        <center>
          @if ($is_admin == true)
            <span>
              <a href="{{ route('fechas/editar_fechas_de_entrega',['periodo' => $periodo_academico->id_periodo_academico, 'formato' =>  config('global.seguimiento_asignatura') ]) }}" title="Editar fechas"><i class="fa fa-pencil rounded-circle" aria-hidden="true"></i></a>
            </span>
          @endif
        </center>
      </div>
    ...
    <div class="card-section card-section-1 border rounded">
      ...
      <div class="card-body mb-2" style="padding: 15px">
        ...
        <center>
          @if ($is_admin == true)
            <span>
              <a href="{{ route('fechas/editar_fechas_de_entrega',['periodo' => $periodo_academico->id_periodo_academico, 'formato' =>  config('global.actividades_complementarias') ]) }}" title="Editar fechas"><i class="fa fa-pencil rounded-circle" aria-hidden="true"></i></a>
            </span>
          @endif
        </center>
      </div>
