...
<div class="row page-titles">
                    <div class="col-md-6 col-8 align-self-center">
                        ...
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="javascript:void(0)">Plan de asignatura</a></li>
      ...
      <div class="card">
          <div class="card-block">
            ...
            <div class="col-sm-5">
                    ...
                    <select class="form-control hasDatepicker form-control-line" id="id_periodo_academico" name="id_periodo_academico">
            ...
            <div class="col-sm-2">
                <br>
                <button type="submit" onclick="if($('#id_asignatura').val() != null && $('#id_periodo_academico').val() != null){ location.href = '/plan_asignatura/view/'+$('#id_asignatura').val()+'/'+$('#id_periodo_academico').val() }else{alert('Es necesario que escoja la asignatura y el periodo academico.')}" class="btn btn-info">Consultar</button>
            </div>
